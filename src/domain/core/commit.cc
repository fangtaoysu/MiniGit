...
Commit::Commit(const CommitMetadata& metadata) : meta_data_(metadata) {
...
const std::string& Commit::GetSha1() const { return sha1_; }

const std::string& Commit::GetTreeSha1() const { return meta_data_.tree_sha1; }

const std::vector<std::string>& Commit::GetParentCommits() const {
    return meta_data_.parent_commits;
}

const std::string& Commit::GetAuthor() const { return meta_data_.author; }

const std::string& Commit::GetCommitter() const { return meta_data_.committer; }

const std::string& Commit::GetMessage() const { return meta_data_.message; }
